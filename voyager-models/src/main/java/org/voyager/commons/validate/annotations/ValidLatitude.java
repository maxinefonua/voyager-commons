...
import org.voyager.commons.validate.validators.LatitudeDoubleValidator;
...
@Documented
@Constraint(validatedBy = {LatitudeDoubleValidator.class, LatitudeStringValidator.class})
