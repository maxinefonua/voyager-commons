...
public final class Regex {
    ...
    public static final String LANGUAGE_CODE = "^[a-z]{2,3}(-[A-Z][a-z]{3,4})?(-[A-Z]{2})?$";
    ...
    public static final class ConstraintMessage {
        ...
        public static final String LANGUAGE_CODE = "must be a valid ISO 639-1 language code with optional script or region tags";
    }
}
