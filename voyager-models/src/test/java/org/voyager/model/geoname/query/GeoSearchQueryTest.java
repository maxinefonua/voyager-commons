package org.voyager.model.geoname.query;
...
class GeoSearchQueryTest {
    ...
    @Test
    void getFeatureCode() {
        geoSearchQuery.setFeatureCode(FeatureCode.ADM1);
        assertEquals(FeatureCode.ADM1,geoSearchQuery.getFeatureCode());
    }
    ...
    void getFuzzy() {
        ...
        geoSearchQuery.setFuzzy(0.5f);
        assertEquals(0.5f,geoSearchQuery.getFuzzy());
    }

    @Test
    void getEast() {
        geoSearchQuery.setEast(10.5f);
        assertEquals(10.5f,geoSearchQuery.getEast());
    }

    @Test
    void getWest() {
        geoSearchQuery.setWest(60.5f);
