...
class GeoNamesConfigTest {
    ...
    void getNearbyPlaceURL() {
        GeoNearbyQuery geoNearbyQuery = GeoNearbyQuery.builder().longitude(10.0).latitude(9.0).radiusKm(10).build();
        ...
        geoNearbyQuery.setRadiusKm(null);
    ...
    void getSearchURL() {
        GeoSearchQuery geoSearchQuery = GeoSearchQuery.builder().query("query").adminCode1("admin").adminCode2("admin")
                ...
                .east(0.1).west(0.1).north(0.1).south(0.1).name("name").fuzzy(null).lang(null).type(null)
                ...
                .charSet(DocumentEncoding.UTF8).featureClass(FeatureClass.P).featureCodeList(List.of(FeatureCode.ADM1))
