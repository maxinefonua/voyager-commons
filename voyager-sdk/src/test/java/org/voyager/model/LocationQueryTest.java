...
class LocationQueryTest {
    ...
    void builderSource() {
        ...
        assertEquals("/locations?source=MANUAL",locationQuery.getRequestURL());
    }
    ...
    void builderLimit() {
        ...
        assertEquals("/locations?limit=20",locationQuery.getRequestURL());
    }
    ...
    void builderStatusList() {
        ...
        assertEquals("/locations?status=ARCHIVED,DELETE",locationQuery.getRequestURL());
    }
    ...
    void builderContinentList() {
        ...
        assertEquals("/locations?continent=AN,AF",locationQuery.getRequestURL());
    }
    ...
    void builderCountryCodeList() {
        ...
        assertEquals("/locations?countryCode=US,TO",locationQuery.getRequestURL());
    }
    ...
    void resolveRequestURL() {
        ...
        assertEquals("/locations?source=GEONAMES&limit=50&countryCode=TO,JP&status=SAVED,NEW&continent=AS,OC",
