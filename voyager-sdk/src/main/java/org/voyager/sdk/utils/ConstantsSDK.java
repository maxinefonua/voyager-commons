...
public class ConstantsSDK {
    ...
    public static String getJsonParseResponseExceptionMessage(String requestURL, HttpResponse<String> response) {
        return String.format(JSON_PARSE_RESPONSE_BODY_EXCEPTION,requestURL,response.statusCode(),response.body());
    }
    public static String getServiceExceptionBlankResponseBody(String requestURL, HttpResponse<String> response) {
